...
<body class="background">
	...
	<section class="Step1" style="display:none">
		<div class="container">
			...
			<div class="row">
				<div class="col col-1">
					...
					<div class="SubHeading">Take our One minute survey and find out how much you can earn from Social
						Media. </div>
					<a href="https://api.instagram.com/oauth/authorize?client_id=815633160634525&redirect_uri=https://www.thevibes.buzz/auth-redirect.php&scope=user_profile&response_type=code" class="Btn LoginWithInstagram"> Login with Instagram <span class="Icon"><img
								src="images/right-icon.svg" alt="icon" /></span></a>
			...
			<div class="FooterMsgFiestPage">
				<div class="FooterLine TextPart">an initiative by <span class="HighlightMsg">The Vibes Network</span>
				</div>
	...
	<section class="Step2" style="display:none">
		<div class="container">
			...
			<div class="row">
				<div class="col col-1">
					<div class="MainHeading MainColor">Verification</div>


					<form>
						<div class="form-group">
							<label for="phoneno">Enter your phone number for OTP</label>
							<div class="input-group">
								<input type="text" maxlength="3" value="+91" disabled required />
								<input type="number" value="9828848399" maxlength="10" class="phone-input num1 mobilenumberInput" required />
							</div>
						</div>
						<div class="form-group OTPgroup otpinputs" style="display:none">
							<label class="labelforOTP" for="phoneno">We have sent the OTP to your number
								<b class="senton">XXXXXXX99</b> </label>
							<div class="input-group">
								<input type="number" maxlength="1" class="otp-input otp1" value='1' required />
								<input type="number" maxlength="1" class="otp-input otp2" value='2' required />
								<input type="number" maxlength="1" class="otp-input otp3" value='3' required />
								<input type="number" maxlength="1" class="otp-input otp4" value='4' required />
							</div>
						</div>
					</form>

                    <a href="javascript:;" class="Btn LoginWithInstagram sendotp"> Send OTP </a>

					<a href="javascript:;" class="Btn LoginWithInstagram NextBtn2 verifotp" style="display:none"> Next <span class="Icon"><img
								src="images/right-icon.svg" alt="icon" /></span></a>
		...
		<div class="container">
			...
			<div class="RowRatio BcRatio ">
				<div class="r-col-1 r-col">
					<div class="RatioHeading">Did you know, <span>your last <b class="ReelsCount"><?php echo $data['ReelsCount'];?></b> insta reels have received</span> </div>

					<div class="ViewCount">
						<div class="InnerCount">
							<div class="EyeIcon"><img src="images/eye.svg" /></div>
							<div class="Text">
								<div class="ViewCountFi totalviews"><?php echo $data['totalViews'];?></div>
								<div class="ViewTitle">views</div>
							</div>
						</div>
					</div>

					<a href="javascript:;" class="Btn NextBtn LoginWithInstagram"> Next <span class="Icon"><img
								src="images/right-icon.svg" alt="icon" /></span></a>
					...
					<div class="InstaPreview">
						<div class="Profile">
							...
							<div class="FollowersDetails">
								...
								<div class="count">
									<div class="fnum totalfollower"><?php echo $data['follower'];?></div>
	...
	<section class="Step4" style="display:none">
		<div class="container">
			<div class="NavGroup">
				<div class="NavBar">
					<div class="MainColor MainHeading MainNav">Hi <span class="loginusername"><?php echo $data['name'];?></span> ! <div class="time">3 seconds to go</div>
					</div>
				</div>
				<div class="ProgressBar"></div>
			</div>
			<div class="RowRatio RowRatio2">
				<div class="r-col-1 r-col">
					...
					<div class="BtnGroup">
						<a href="javascript:;" class="Btn LoginWithInstagram storeContent"> Next <span class="Icon"><img
									src="images/right-icon.svg" alt="icon" /></span></a>
		...
		<div class="container">
			...
			<div class="RowRatio RowRatio2">
				<div class="r-col-1 r-col">
					...
					<div class="BtnGroup">
						<a href="javascript:;" class="Btn LoginWithInstagram aboutContent"> Next <span class="Icon"><img
									src="images/right-icon.svg" alt="icon" /></span></a>
						<div class="tiptext">Select between 1 to 5 options</div>
					</div>
	...
	<section class="Step6" style="display:none">
		<div class="container">
			<div class="NavGroup">
				<div class="NavBar">
					<div class="MainColor MainHeading MainNav">Hi <span class="loginusername"><?php echo $data['name'];?></span> ! <div class="time">2 seconds to go</div>
					</div>
				</div>
				<div class="ProgressBar"></div>
			</div>
			<div class="RowRatio BcRatio3">
				<div class="r-col-1 r-col">
					<div class="RatioHeading">Did you know, <span>your last <b class="ReelsCount">12</b> insta reels have received</span> </div>

					<div class="ViewCount ViewCount2">
						<div class="InnerCount InnerCount2">
							<div class="EyeIcon"><img src="images/like.svg" /></div>
							<div class="Text">
								<div class="ViewCountFi totallikes"><?php echo $data['totalLikes'];?></div>
								<div class="ViewTitle">likes</div>
							</div>
						</div>
					</div>

					<a href="javascript:;" class="Btn LoginWithInstagram NextBtn"> Know More <span class="Icon"><img
								src="images/right-icon.svg" alt="icon" /></span></a>
	...
	<section class="Step7" style="display:none">
		<div class="container">
			<div class="NavGroup">
				<div class="NavBar">
					<div class="MainColor MainHeading MainNav">Hi <span class="loginusername"><?php echo $data['name'];?></span> ! <div class="time">1 seconds to go</div>
					</div>
				</div>
				<div class="ProgressBar"></div>
			</div>
			<div class="RowRatio RowRatio2">
				<div class="r-col-1 r-col">
					...
					<div class="BtnGroup">
						<a href="javascript:;" class="Btn LoginWithInstagram saveAboutcontent"> Next <span class="Icon"><img
									src="images/right-icon.svg" alt="icon" /></span></a>
						<div class="tiptext">Select between 1 to 5 options</div>
					</div>
	...
	<section class="Step8" style="display:none">
		<div class="container">
			<div class="NavGroup">
				<div class="NavBar">
					<div class="MainColor MainHeading MainNav">Hi <span class="loginusername"><?php echo $data['name'];?></span> ! <div class="time">0 seconds to go</div>
					</div>
				</div>
			...
			<div class="RowRatio RowRatio2">
				<div class="r-col-1 r-col">
					...
					<a href="javascript:;" class="Btn LoginWithInstagram mrtop earn_capacity"> Your earning capacity <span
							class="Icon"><img src="images/right-icon.svg" alt="icon" /></span></a>
			...
			<div class="rowthree">
				...
				<div class="three_two three three2222 earning_result">
					...
					<div class="BuzzLogo"><img src="images/BuzzLogo.svg" /></div>
						<div class="PaymentHeader">
							<div class="websiteAddress">www.vibes.buzz</div>
						...
						<div class="NameGorupPayment">
							...
							<div class="SubHeading2">Here is your Report card</div>
						</div>
						<div class="EarningCard">
							<div class="EarnLine1">You can earn upto</div>
							<div class="EarningAmount">₹ <?php echo $data['total_earning'];?></div>
						...
						<div class="InstaProfileInDetails bottommargin">
							<div class="InstaInfoCount">
								...
								<div class="CountInsta totalfollower"><?php echo $data['follower'];?></div>
							</div>
							<div class="InstaInfoCount">
						...
						<div class="InstaProfileInDetails MorePerformaceCount">
						    <div class="PerformanceReach">Performance of your last <span class="ReelsCount">10</span> reels</div>
						...
						<div class="RecommendationsByVibes">
							...
							<div class="Recommendation viewmax20">Great job! Your view rate shows strong connect with audience. Keep engaging with fresh content, and try grabbing attention in the first 3 seconds using a mix of speaking-to-camera and trending audio.</div>
							<div class="Recommendation viewless20">Your views could be improved. Consider improving video quality, grab attention in first 3 seconds and posting regularly.</div>
							<div class="Recommendation engmax6">You have an amazing engagement with your audience. Keep understanding your audience demographics, create targeted videos with clear call to action</div>
							<div class="Recommendation engless6">You need to improve your engagement with your audience. Focus on understanding your audience, create videos that asks questions and use interactive stickers.</div>
						</div>
				...
				<div class="three_three three three2222">
					<div class="DIconGroup">
						...
						<div class="shareIcon NextBtn"><img src="images/share.svg" /> Share</div>
					</div>
				</div>
			</div>
	...
	<section class="Step10" style="display:none">
		<div class="container">


			<div class="rowthree theeboxceneter">
			    <div class="closeShareView">X</div>
			
				<div class="three_two three">

					<div class="PaymentBox PaymentBox2">
					    <div class="seconPaybox">
					<div class="BuzzLogo"><img src="images/BuzzLogo.svg"></div>
						<div class="PaymentHeader">
							<div class="websiteAddress">www.vibes.buzz</div>
	...
	<section class="Step11" style="display:none">
		<div class="container">
			...
			<div class="rowthree theeboxceneter">
				...
				<div class="three_two three">
				    <img class="loaderrr" src="images/loading.gif" alt="loading" />
