...
if(isset($_POST['paid_collaboration'])){
    ...
    if ( isset($_POST['youtube_id']) ) {
        $youtube_id = trim( strip_tags( $_POST['youtube_id'] ) );
    }
    $_SESSION['youtube_id'] = $youtube_id;

    //-----------
    $your_caste = array_map('trim', $_POST['your_caste']);
    $your_caste = array_filter($your_caste);
    $your_caste = implode(',', $your_caste);
    
    $_SESSION['your_caste'] = $your_caste;
    ...
    $data['your_caste'] = $_SESSION['your_caste'];
    $data['youtube_id'] = $_SESSION['youtube_id'];
...
if(isset($_POST['cap_name'])){
    ...
    if(isset($_POST['cap_gender']) && $_POST['cap_gender'] != ''){
        $_SESSION['your_gender'] = $_POST['cap_gender'];
        $data['your_gender'] = $_SESSION['your_gender'];
    }
    
    if(isset($_POST['cap_age']) && $_POST['cap_age'] != '' && is_numeric($_POST['cap_age'])){
        $_SESSION['your_age'] = $_POST['cap_age'];
